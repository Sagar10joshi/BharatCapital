...
const Home = () => {
  const highlights = [
    {
      icon: TrendingUp,
      title: '185% Average Return',
      description: 'Consistent performance over 5 years',
      value: '+285%'
    },
    {
      icon: DollarSign,
      title: '₹2,24,000 Portfolio Value',
      description: 'Built from ₹50,000 initial investment',
      value: '₹2,24,000 '
    },
    {
      icon: Users,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate-fade-up">
              ...
              <div className="flex items-center space-x-8 pt-8">
                <div className="text-center">
                  ...
                  <div className="text-sm text-muted-foreground">Stocks Trade</div>
                </div>
                <div className="text-center">
            ...
            <div className="relative animate-slide-in">
              <div className="relative rounded-2xl overflow-hidden">
                <img
                  src={traderHero}
                  alt="Bharat Sanwal - Professional Stock Trader"
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-card/90 backdrop-blur-sm rounded-lg p-4 border border-border">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-semibold">Bharat Sanwal</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg text-muted-foreground">
              I'm Bharat Sanwal, a professional stock trader with over 5 years of experience in the financial markets. 
              Starting with just ₹50,000, I've built a portfolio worth over ₹2,24,000 through disciplined trading strategies 
